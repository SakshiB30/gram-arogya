      ...
      <div>
        ...
        <div className="border-b border-slate-100 px-5 py-5">
          <div className="flex items-center gap-3">
            <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-violet-500 to-blue-500 shadow-md shadow-violet-500/20">
          ...
          <div className="mt-4 rounded-lg bg-gradient-to-r from-violet-50 to-blue-50 px-3 py-2">
            ...
            return (
              <button
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-left text-[14.5px] font-medium transition-colors ${
                  isActive
                    ? "bg-gradient-to-r from-violet-600 to-blue-600 text-white shadow-md shadow-violet-600/20"

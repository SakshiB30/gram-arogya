      ...
      <Container>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3 max-w-3xl mx-auto">
          <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-slate-200">
            ...
            <h4 className="mt-3 font-semibold">Field Support</h4>
            <p className="text-slate-600 text-sm">ASHA-focused healthcare workflow</p>
          </div>
          <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-slate-200">
            <Mail className="h-8 w-8 text-emerald-600 mx-auto" />
            <h4 className="mt-3 font-semibold">Digital Records</h4>
            <p className="text-slate-600 text-sm">Secure beneficiary and health information</p>
          </div>
          <div className="text-center p-6 bg-white rounded-xl shadow-sm border border-slate-200">
            <MapPin className="h-8 w-8 text-orange-600 mx-auto" />
            <h4 className="mt-3 font-semibold">Rural Focus</h4>
            <p className="text-slate-600 text-sm">Designed for low-connectivity environments</p>
          </div>
        </div>
      </Container>
    </section>
